# =============================================================================
# TOPLID LEFT, TWO-PASS, 0.45 BASELINE  —  toplid_left_002_v45
# =============================================================================
...
# THE 0.45 VARIANT: identical geometry and R_LIST to toplid_left_002;
# every stroke's V_LIST entry is capped at 65 (0.29 m/s, J4 <= ~85 pct —
# the strokes are J4-bound and CANNOT run 0.45, 9.3e), while hops, rim
# and edge ride the higher baseline. The preflight gate scales its
# prediction by V_LIST (2026-08-15 patch), so it screens the speeds the
# moves actually command. Run ONLY after toplid_left_002 passed in REAL
# at 0.25, and run reset_limits.py afterwards (limits ratchet, H62).
#
...
V_LIST = [60, 65, 60, 65, 60, 65, 60, 65, 60, 65, 60, 65, 60, 65, 60, 65, 60, 65, 60, 65, 60, 65, 60, 65, 60, 65, 60, 65, 60, 65, 65, 60, 60, 60, 60, 60, 60, 60, 60]
